...
#include <memory>
#include "../../SudokuApplication/mymodel.h"
...
QT_MOC_LITERAL(6, 41, 4) // "role"

    },
    "MyModel\0setData\0\0QModelIndex\0index\0"
    "value\0role"
};
...
static const uint qt_meta_data_MyModel[] = {
 ...
 // slots: name, argc, parameters, tag, flags
       ...
       1,    2,   31,    2, 0x28 /* Private | MethodCloned */,

 // slots: parameters
    QMetaType::Bool, 0x80000000 | 3, QMetaType::QVariant, QMetaType::Int,    4,    5,    6,
...
void MyModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { bool _r = _t->setData((*reinterpret_cast< const QModelIndex(*)>(_a[1])),(*reinterpret_cast< const QVariant(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 1: { bool _r = _t->setData((*reinterpret_cast< const QModelIndex(*)>(_a[1])),(*reinterpret_cast< const QVariant(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
